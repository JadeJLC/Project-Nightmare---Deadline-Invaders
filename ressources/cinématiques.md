...
- **Scène**
- Le nouveau collègue (à nommer par le joueur) arrive dans l'entreprise et le patron le place dans l'équipe du joueur
- Le collègue a déjà l'air prétentieux dès le début
- **Texte**
...
- **Scène**
- Le projet est terminé et majoritairement (ou complètement si 100%) fonctionnel. Le patron félicite l'équipe.
- Le collège s'attribue tout le mérite du travail
...
- **Scène**
- Encore une fois, le collègue s'attribue tout le mérite du travail de ses collègues.
...
- _Les managers approuvent_
- (Patron) Je propose donc de le promouvoir au rang de manager. Il peut gérer facilement de plus grosses équipes.

## Cinématique de niveau raté

- **Scène**
- Le projet n'est pas fonctionnel et le patron est mécontent
...
## Cinématique de fin - bad ending (plus de vies)

- **Scène**
- Devant l'échec répété des projets, le patron décide de démanteler l'équipe.

## Cinématique de fin - good ending (finir le niveau 3 à plus de 50%)

- **Scène**
- Le patron est content des résultats de l'équipe.
- L'équipe parvient enfin à prendre la parole et à expliquer que le collègue relou leur a mis des bâtons dans les roues sur les projets et est plus une gêne qu'une aide.
- Incapable de se justifier devant les preuves, le collègue est renvoyé.
- Party time

## Cinématique de fin - perfect ending (finir tous les niveaux à 100%)

- **Scène**
- Lance d'abord la cinématique good ending
- Scène bonus : après le départ du collègue relou, le patron convoque le joueur dans son bureau
- Le joueur est promu chef de projet car les autres membres de l'équipe ont expliqué le rôle qu'il a joué dans les projets
